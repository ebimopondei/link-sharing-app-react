...
export default function InputField({ type = 'text', onChange, input= { id: '1', platform: '', link: '' }, message="can't be empty", className, placeholder, Icon, error=false, success=false }: InputFieldType) {
